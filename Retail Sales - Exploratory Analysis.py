...
print('The city with the most customers was City Code 4.0')

print("Time period of the available transaction data is from "+ str(df_new['tran_date'].min()) + " to " 
      + str(df_new['tran_date'].max()))
